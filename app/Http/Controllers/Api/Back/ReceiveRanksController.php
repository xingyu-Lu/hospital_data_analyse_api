...
class ReceiveRanksController extends Controller
{
    public function export(Request $request)
    {
        ...
        $data = ReceiveChargeName::where($where)->orderBy('money', 'desc')->get();
        ...
        $total_money = ReceiveIncome::where($where)->sum('total_money');
        ...
        $worksheet->setTitle($office_name . '-接单排名');
        ...
        foreach ($res_data as $key => $value) {
         ...
         //下载
        $filename = $office_name . '-接单排名' . '.xlsx';
